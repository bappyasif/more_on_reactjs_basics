...
import {ContainerForReactIntroductions} from "./react_introductions/ContainerForReactIntroductions";
...
export default class App extends Component {
  constructor(props) {
    ...
    this.clickedHandler5 = this.clickedHandler5.bind(this);
  }
  ...
  render() {
    return (
      <div className="App" style={{ backgroundColor: randomcolor() }}>
        ...
        <ContainerForAdvancedConcepts show={this.state.show5} clickHandler={this.clickedHandler5} />

        {/* react introductions */}
        <ContainerForReactIntroductions />
      </div>
    );
  }
}
